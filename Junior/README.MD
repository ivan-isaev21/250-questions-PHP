...
62. [Что означает утверждение о том, что СУБД поддерживает контроль ссылочной целостности связей?](https://studme.org/77264/informatika/ogranicheniya_ssylochnoy_tselostnosti)
